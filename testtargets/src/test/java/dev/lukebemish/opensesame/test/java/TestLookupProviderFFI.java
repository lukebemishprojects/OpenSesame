...
public class TestLookupProviderFFI {
    ...
    void lookupHasOriginalAccess() throws Throwable {
        ...
        var lookup = invokeOpeningLookup(provider, MethodHandles.lookup(), TestLookupProviderFFI.class);
        // Test if it is IMPL_LOOKUP, by using it to grab IMPL_LOOKUP
        var getter = lookup.findStaticGetter(MethodHandles.Lookup.class, "IMPL_LOOKUP", MethodHandles.Lookup.class);
        getter.invoke();
    }
